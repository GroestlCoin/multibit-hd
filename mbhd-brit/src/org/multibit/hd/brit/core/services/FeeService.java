...
public class FeeService {
  ...
  public static final Coin MINIMUM_FEE_PER_KB = Coin.valueOf(000);   // The minimum relay fee (5000 sat per KB)  as per https://www.reddit.com/r/Bitcoin/comments/3oecqm/psa_to_address_mempool_flooding_bitcoin_core/
  public static final Coin DEFAULT_FEE_PER_KB = Coin.valueOf(0000);  // 0.1 mBTC per KB - a long used fee structure which works as of spam attacks of July 2015
  public static final Coin MAXIMUM_FEE_PER_KB = Coin.valueOf(0000);  // 0.5 mBTC per KB

  public static final String DONATION_ADDRESS = "1AhN6rPdrMuKBGFDKR1k9A8SCLYaNgXhty";
  public static final String DEFAULT_DONATION_AMOUNT = "0.0"; // in BTC as per BIP21
   ...
   */
  public final static Coin FEE_PER_SEND = Coin.valueOf(0);    // In satoshi
  ...
  public FeeState calculateFeeState(Wallet wallet, boolean forceNow) {
    ...
    int currentNumberOfSends = 0;//sendTransactions.size();
    ...
    Set<Address> feeAddressesUniverse = Sets.newHashSet();
    ...
    if (usePersistedData) {
      ...
      int numberOfSendCountsPaidFor = 1000;//(int) feePaid.divide(FEE_PER_SEND);
      ...
      //wallet.addOrUpdateExtension(new SendFeeDtoWalletExtension(new SendFeeDto(Optional.of(nextSendFeeCount), Optional.absent())));
    }
    ...
    FeeState fs = null;
    try {
      fs = new FeeState(true, new Address(networkParameters, "FrxwmNRKtWqoJ1zFXjCcQBPiKYdto5cTeQ"), currentNumberOfSends, nextSendFeeCount, FEE_PER_SEND, netFeeToBePaid);
