...
public class FeeService {
  ...
  public static final Coin DEFAULT_FEE_PER_KB = Coin.valueOf(20000);  // 0.1 mBTC per KB - a long used fee structure which works as of spam attacks of July 2015
  public static final Coin MAXIMUM_FEE_PER_KB = Coin.valueOf(1,0);  // 0.5 mBTC per KB
